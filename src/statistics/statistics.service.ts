...
export class StatisticsService {
  ...
  async getStatisticsBusPassengersInfo(start_date: string, end_date: string): Promise<any[]> {
  ...
  async getStatisticsOccupancyRateInfo(start_date: string, end_date: string): Promise<any[]> {
  ...
  async getStatisticsArrivalRateInfo(start_date: string, end_date: string): Promise<any[]> {
  ...
  async getStatisticsRealtimeRouteUsageInfo(datetime: string, limit: number): Promise<any[]> {
